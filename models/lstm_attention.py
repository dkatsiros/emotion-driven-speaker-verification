...
class LSTM_Attention(nn.Module):
    ...
    def __init__(self, input_size, hidden_size=16, output_size=7, num_layers=1,
        ...
        # Attention layer
        self.attn = nn.Linear(self.hidden_size + output_size, output_size)
        # Final layer
    ...
    def forward(self, x, lengths):
        ...
        Arguments:
            x : 3D numpy array of dimension N x L x D
                ...
                L: sequence index
                D: feature index
            lengths: Real length of each sequence
        ...
        attn_weigths = F.softmax(self.attn(in_features=torch.cat(
            hidden, hidden), dim=1))
        # Apply attention
        attn_applied =
