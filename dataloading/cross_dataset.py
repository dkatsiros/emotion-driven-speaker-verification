...
class CrossDataset(Dataset):
    ...
    def __init__(self, X, y, feature_extraction_method="MFCC", oversampling=False, max_sequence_length=200):
...
### Arguments:
        ...
        max_sequence_length {int} : Max sequence lengths of datasets
        """
    ...
    def __len__(self):
        """Returns length of CrossDataset dataset."""
        return len(self.X)
